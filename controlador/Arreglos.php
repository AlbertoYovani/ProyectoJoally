...
if($_POST['accion']=='AgregarArreglo'){
    ...
    for ($index = 1; $index <= $pedidos_cantidad; $index++) {
       $sql= mysqli_query(ConexionBd(), "INSERT INTO jy_pedidos_tmp (pedidos_id,pedidos_fecha,pedidos_hora,cliente_id,cliente_tmp,arreglo_id,clasificacion_id,tamanio_id,dedicatoria) 
